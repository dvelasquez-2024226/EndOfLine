    ...
    public List listar (){
        ...
        try{
            ...
            while(rs.next()){
                ...
                co.setTelefonoConcesionario(rs.getString(3));
                co.setCorreoConcesionario(rs.getString(4));
...
// AGREGAR
    ...
    public int agregar (Concesionario co){
        String sql= "insert into concesionario (nombreConcesionario, correoConcesionario, telefonoConcesionario, direccionConcesionario, codigoInventario) values (?, ?, ?, ?, ?)" ;
        
        try{
            con = cn.Conexion();
            ps = con.prepareStatement(sql);
            ps.setString(1, co.getNombreConcesionario());
            ps.setString(2, co.getTelefonoConcesionario());
            ps.setString(3, co.getCorreoConcesionario());
    ...
    public Concesionario listarCodigoConcesionario(int id){
        ...
        Concesionario co = new Concesionario();
        String sql = "Select * from Concesionario where codigoConcesionario ="+id;
        try{
            con = cn.Conexion();
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public int actualizar (Concesionario co){
        String sql = "update concesionario set "
                + "nombreConcesionario = ?, telefonoConcesionario = ?,"
                + "correoConcesionario = ?, direccionConcesionario = ?";
        ...
        try{
            ...
            ps.setString(3, co.getCorreoConcesionario());
            ps.setString(4, co.getDireccionConcesionario());
            ps.setInt(5, co.getCodigoConcesionario());
            ps.executeUpdate();
    ...
    public void eliminar (int id){
        String sql = "delete from concesionario where codigoConcesionario="+id;
