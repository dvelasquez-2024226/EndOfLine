        ...
        if (menu.equals("NavCliente")) {
            ...
            switch(accion){
                ...
                case "Agregar":
                    ...
                    servicio.setTipoServicios(tise);
                    servicio.setFechaSalida(feSali);
                    servicio.setEmpleados_carne(emCa);
                    servicio.setTaller_notaller(taNo);
                    break;
                case "Editar":
                ...
                case "Actualizar":
                    ...
                    servicio.setTipoServicios(tiSeSer);
                    servicio.setFechaIngreso(feSaliSer);
                    servicio.setEmpleados_carne(emCaSer);
                    servicio.setTaller_notaller(taNoSer);
