                ...
                <div class="card-body">
                    <form action="Controlador?menu=Servicio" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${Servicio.getTipoServicios()}" name="txtTipoServicio" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${Servicio.getEmpleados_carne()}" name="txtEmpleados_Carne" class="form-control">
                        </div>
                        <div class="form-group">
                            <label><strong>TALLER</strong></label>
                            <input type="text" value="${Servicio.getTaller_notaller()}" name="txtTaller_Notaller" class="form-control">
                        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>    
                        <c:forEach var="servicio" items="${servicios}">
                            <tr>
                                <td>${servicio.getNoServicios()}</td>
                                <td>${servicio.getFechaIngreso()}</td>
                                <td>${servicio.getDetalles()}</td>
                                <td>${servicio.getTipoServicios()}</td>
                                <td>${servicio.getFechaSalida()}</td>
                                <td>${servicio.getEmpleados_carne()}</td>
                                <td>${servicio.getTaller_notaller()}</td>
                                <td>
